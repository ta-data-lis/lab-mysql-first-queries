...
#From the the ten most rated apps, which means, the apps which received more reviews on appstore, 
#Facebook aggreagated the most ratings, counting 2974676 rating overall, and Angry Birds the least, with 824451.

/* 8. Take a look on the data you retrieved in the question 6. Give some insights. */
SELECT COUNT(*), user_rating
FROM lab_1.applestore
Group by user_rating;
#The 10 best rated apps, which means, the apps that on average reached higher average ratings, dispise the number of ratings, 
#all got an average rating of 5. However, from another query, it's possible to conclude that in total exist 490 apps rated with a score of 5, hence being a top of 490
...
ORDER BY rating_count_tot DESC
LIMIT 10;
#The apps with more votes aren't necessarly the ones with the better rating. Per example, Facebook was the app with the highest rating count, but is the one with the lowest average rate
