...
/* We can see that the lower the price is, the more people rate the app, which means that there are more 
people buying the app and thus reviewing it. So, in a way, people apparentely care about the price because
they tend to buy the cheapest apps more than the expensive ones. But it's hard to conclude more than decide,
because it depends of what the app gives you.*/
